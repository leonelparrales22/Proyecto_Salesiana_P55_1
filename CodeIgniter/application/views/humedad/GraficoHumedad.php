...
<figure class="highcharts-figure">
    ...
    <p class="highcharts-description">
        Gráfico de humedad que muestra la actualización de datos cada segundo, con la eliminación de datos antiguos.
    </p>
</figure>
        ...
        events: {
            load: function () {
                ...
                myTimervar = setInterval( async function () {
                    ...
                    y = parseInt(await fetch('<?php echo base_url();?>index.php/Humedad/llamadabase')
