      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="GraficoTemperatura.php">Temperatura</a>
            <a class="collapse-item" href="GraficoPresion.php">Presión</a>
            <a class="collapse-item" href="GraficoHumedad.php">Humedad</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="utilities-color.html">Ventilador</a>
            <a class="collapse-item" href="utilities-border.html">Foco</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="temperatura.php">Temperatura</a>
            <a class="collapse-item" href="humedad.php">Humedad</a>
            <a class="collapse-item" href="presion.php">Presión</a>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <span class="mr-2 d-none d-lg-inline text-gray-600 small">Juma W., Fernandez J., Morales D., Parrales L, Quisupangui E.,
                Velasco B.</span>
              <img class="img-profile rounded-circle" src="img/Logo-Salesiana.png">
              </a>
