 <!-- Footer -->
  ...
  <!-- Page level plugins -->
  <script src="<?php echo base_url();?>application/assets/vendor/chart.js/Chart.min.js"></script>

  <!-- Page level custom scripts -->
  <script src="<?php echo base_url();?>application/assets/js/demo/chart-area-demo.js"></script>
  <script src="<?php echo base_url();?>application/assets/js/demo/chart-pie-demo.js"></script>
