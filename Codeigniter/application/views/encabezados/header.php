...
<head>
  ...
  <link href="<?php echo base_url();?>application/assets/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
  <link
    href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i"
    rel="stylesheet">

  <!-- Custom styles for this template-->
  <link href="<?php echo base_url();?>application/assets/css/sb-admin-2.min.css" rel="stylesheet">

  <!-- Custom styles for this page -->
  <link href="<?php echo base_url();?>application/assets/vendor/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <span class="mr-2 d-none d-lg-inline text-gray-600 small">Juma W., Fernandez J., Morales D., Parrales L, Quisupangui E.,
                Velasco B.</span>
              <img class="img-profile rounded-circle" src="<?php echo base_url();?>application/assets/img/Logo-Salesiana.png">
              </a>
